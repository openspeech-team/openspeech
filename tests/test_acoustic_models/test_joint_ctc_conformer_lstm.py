...
from openspeech.models import JointCTCConformerLSTMConfigs, JointCTCConformerLSTMModel
...
class TestJointCTCConformerLSTM(unittest.TestCase):
    def test_forward(self):
        configs = build_dummy_configs(
            model_configs=JointCTCConformerLSTMConfigs(),
            criterion_configs=JointCTCCrossEntropyLossConfigs(),
        )

        vocab = KsponSpeechCharacterTokenizer(configs)
        model = JointCTCConformerLSTMModel(configs, vocab)

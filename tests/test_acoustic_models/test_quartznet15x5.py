...
from openspeech.models import QuartzNet15x5Configs, QuartzNet15x5Model
...
class TestQuartzNet15x5(unittest.TestCase):
    def test_forward(self):
        configs = build_dummy_configs(model_configs=QuartzNet15x5Configs(), criterion_configs=CTCLossConfigs())

        vocab = KsponSpeechCharacterTokenizer(configs)
        model = QuartzNet15x5Model(configs, vocab)

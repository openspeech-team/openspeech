...
from openspeech.models import QuartzNet5x5Configs, QuartzNet5x5Model
...
class TestQuartzNet5x5(unittest.TestCase):
    def test_forward(self):
        configs = build_dummy_configs(model_configs=QuartzNet5x5Configs(), criterion_configs=CTCLossConfigs())

        tokenizer = KsponSpeechCharacterTokenizer(configs)
        model = QuartzNet5x5Model(configs, tokenizer)
